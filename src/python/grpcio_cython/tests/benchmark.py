...
"""Benchmark grpcio-cython against pure-Python handlers.
...
def main():
    ...
    native_server, native_port = start_server(
        {
            "Hash": grpcio_cython.native_unary_unary_rpc_method_handler(
                module, "fnv1a_hash"
            ),
            "MatMul": grpcio_cython.native_unary_unary_rpc_method_handler(
                module, "matmul"
            ),
        }
    )
