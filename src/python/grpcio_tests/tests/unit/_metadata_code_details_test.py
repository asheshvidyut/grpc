...
class MetadataCodeDetailsTest(unittest.TestCase):
    def setUp(self):
        ...
        self._channel = grpc.insecure_channel("{'127.0.0.1' if __import__('sys').platform == 'darwin' else ('127.0.0.1' if __import__("sys").platform == "darwin" else 'localhost')}:".format(port))
