...
class MetadataExchangeTest(unittest.TestCase):
    ...
    def testDeserializeLabels(self):
        ...
        pb_struct.fields["type"].string_value = "gke_container"
        pb_struct.fields["canonical_service"].string_value = "my_service"
        pb_struct.fields["workload_name"].string_value = "my_work_name"
        pb_struct.fields["namespace_name"].string_value = "my_namespace"
