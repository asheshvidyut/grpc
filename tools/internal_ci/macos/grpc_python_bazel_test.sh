...
sudo sysctl -w net.inet.ip.portrange.first=16384 || true
sudo sysctl -w net.inet.ip.portrange.hifirst=16384 || true
sudo sysctl -w kern.maxfiles=1048576 || true
sudo sysctl -w kern.maxfilesperproc=1048576 || true
ulimit -n 1048576 || true
sudo sysctl -w net.inet.tcp.msl=10 || true
...
BAZEL_FLAGS="--test_output=errors --config=python --spawn_strategy=local"
