...
def targets():
    ...
    return _reorder_targets_for_build_speed(
        [
            ...
            PythonArtifact(
                "manylinux2014", "aarch64", "cp310-cp310", presubmit=True
            ),
            PythonArtifact(
                "manylinux2014", "aarch64", "cp311-cp311", presubmit=True
            ),
            PythonArtifact(
            ...
            PythonArtifact(
                "musllinux_1_2", "aarch64", "cp310-cp310", presubmit=True
            ),
            PythonArtifact(
                "musllinux_1_2", "aarch64", "cp311-cp311", presubmit=True
            ),
            PythonArtifact(
                "musllinux_1_2", "aarch64", "cp312-cp312", presubmit=True
            ),
            PythonArtifact(
